...
<!-- check if the teacher is assigned in courses -->
...
<% for(String courseID:courses.keySet()){ %>
 ...
 <tr> 
  ...
  <td><a href="/AssessmentSystem/ViewStudentServlet?courseID=<%=courseID %>">view</a></td>
 </tr>
...
<% }else {%>
<tr>
<td>You are not assigned any courses.</td>
</tr>
</table>
...
<form action="/AssessmentSystem/ChooseCoursesServlet" method="post">
  ...
  <!-- retrieve all the courses for the teacher to choose-->
